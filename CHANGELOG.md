...
- Add [useFilenamingConvention](https://biomejs.dev/linter/rules/use-filenaming-convention) that enforces naming conventions for JavaScript and TypeScript filenames.
  The rule provides an option to choose a specific convention. Contributed by @Conaclos
